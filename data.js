...
const personalInfo = {
  ...
  email: "hamidaitbajja2@gmail.com",
  ...
  social: {
    ...
    cv: 'https://drive.google.com/file/d/1I6uqsaW06U4WkDrHrV3v3diU-kbEAdeZ/view?usp=drive_link'
  },
...
const experiences = [ 
  {
    ...
    details: [
      ...
      "Development of CAPL scripts in CANoe to monitor communication on Ethernet, CAN, and LIN networks in a HIL environment.",
...
const projects = [
  {
    ...
    githubLink: 'https://github.com/hmdait/Autonomous_Car.git'
  },
  {
    id: 2,
    name: 'Mery',
    ...
    githubLink: 'https://github.com/hmdait/Assistant_Response'
  },
  {
    id: 3,
    name: 'Alicona',
    ...
    githubLink: 'https://github.com/hmdait/confocal_measurement'
  }
];
...
const skills = {
  ...
  frameworks: [
    { name: 'Robot Framework', level: 'Intermediate', percentage: 60 },
    { name: 'VueJs', level: 'Beginner', percentage: 40 },
    { name: 'Flask', level: 'Beginner', percentage: 40 }
  ],
  ...
  simulationTools: [
    ...
    { name: 'Vector [CANoe, CANalyzer, CANape]', level: 'Advanced', percentage: 80 },
